...
$sql = "SELECT * FROM post WHERE category='$category_id'";
$result = mysqli_query($conn, $sql);
$category_name = mysqli_fetch_assoc(mysqli_query($conn, "SELECT category_name FROM category WHERE
...
<body>
    ...
    <div class="container">
      ...
      <div class="design-content">
        ...
        <?php $sql1 = "SELECT * FROM post WHERE category={$category_id}";
